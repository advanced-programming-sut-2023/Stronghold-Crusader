...
public enum MobileUnitConstants {
    ...
    ENGINEER(1, 5, 0, 100, MapAssetType.ENGINEER, 15, true),
    LADDER_MAN(1, 8, 0, 100, MapAssetType.LADDER_MAN, 10, false),
    SIEGE_TOWER(1, 3, 4, 200, MapAssetType.SIEGE_TOWER, 45, false),
    MOBILE_SHIELD(1, 6, 1, 60, MapAssetType.MOBILE_SHIELD, 5, false),
    COW(1, 5, 0, 1, MapAssetType.COW, 0, false);
